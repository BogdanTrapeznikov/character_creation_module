...
# Переменная класса — диапазон значения атаки.
DEFAULT_ATTACK = 5
# Переменная класса — диапазон значения защиты.
DEFAULT_DEFENCE = 10
DEFAULT_STAMINA = 80
...
class Character:
    ...
    # Константа с названием умения
    SPECIAL_SKILL = 'Удача'
    # Константа со значением очков урона
    SPECIAL_BUFF = 15
    # Константа с описанием персонажа
